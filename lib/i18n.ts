...
const en: TranslationDict = {
    ...
    'camera.analyzeFailed': 'Analysis failed',
    'camera.pickFromGallery': 'Pick from gallery',
    'camera.galleryPermission': 'Photo library access is needed to pick an image.',
    'scan.result.title': 'Scan result',
    'scan.result.uploadedImage': 'Uploaded image',
    'scan.result.foodInfo': 'Food info',
    'scan.result.confidence': 'Confidence',
    'scan.result.source': 'Result source',
    'scan.result.ingredients': 'Ingredients',
    'scan.result.allergies': 'Detected allergens',
    'scan.result.matchedAllergies': 'Your allergens',
    'scan.result.matchedReligious': 'Religious restrictions',
    'scan.result.reason': 'Why this result',
    'scan.result.empty': 'No analysis result.',
    ...
    'allergy.religiousChoose': 'Choose all dietary restrictions that apply.',
...
const ko: TranslationDict = {
    ...
    'camera.analyzeFailed': '분석에 실패했습니다',
    'camera.pickFromGallery': '갤러리에서 선택',
    'camera.galleryPermission': '이미지를 선택하려면 사진 보관함 접근 권한이 필요합니다.',
    'scan.result.title': '스캔 결과',
    'scan.result.uploadedImage': '업로드한 이미지',
    'scan.result.foodInfo': '음식 정보',
    'scan.result.confidence': '신뢰도',
    'scan.result.source': '결과 출처',
    'scan.result.ingredients': '재료',
    'scan.result.allergies': '검출된 알러지',
    'scan.result.matchedAllergies': '내 알러지',
    'scan.result.matchedReligious': '종교 제한',
    'scan.result.reason': '분석 근거',
    'scan.result.empty': '분석 결과가 없습니다.',
    ...
    'allergy.religiousChoose': '해당하는 식이 제한을 모두 선택하세요.',
